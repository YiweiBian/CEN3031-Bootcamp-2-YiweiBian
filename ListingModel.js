...
const Listing = sequelize.define('Listing', {
  ...
  //ADD CODE HERE
    code: {
        ...
        validate: {
            isUppercase: true,//make sure codes have maximum length of 4 and all uppercase
        }
    },
    name: {
        type: DataTypes.STRING
    },
    coordinates: {//nested attributes
        type: DataTypes.JSONB,
        latitude: {
            type: DataTypes.FLOAT
        },
        longitude: {
            type: DataTypes.FLOAT//use floats to store coordinates
        }
    }, 
    address: {
        type: DataTypes.STRING
  ...
  // Other model options go here
    tableName: 'Listings',
    timestamps: false//remove time stamps
});
